# Advertorial Framework: 9-Section Architecture
...
Before delivering any advertorial, verify this chain holds:

```
ROOT CAUSE → "I believe THIS is what's actually causing my problem"
     ↓
UNIQUE MECHANISM → "I believe THIS approach can fix that root cause"
     ↓
PRODUCT → "I believe THIS product delivers that mechanism"
     ↓
CLOSE → "This is the obvious choice. Where do I buy it?"
```

If any link is weak or the chain breaks, the entire conversion architecture fails.
...
**MC Principle:** Length is determined by the job each section needs to do, not by a target word count. If the root cause clicks in 150 words, use 150. If it needs 300, use 300. But never use more words than the job requires.

**What "the right length" feels like:** Short paragraphs (2-3 sentences). Short sentences. Visual breaks every 3-4 paragraphs. Even if the full page is long, it should never FEEL long. Every sentence creates curiosity, builds belief, or deepens emotional connection. If a sentence could be removed without the reader missing anything, remove it.

**Practical proxy for Claude:** After writing each section, do a deletion pass. Read every sentence and ask: does this create curiosity, build belief, deepen identification, handle an objection, or move the reader toward the next section? If a sentence does none of these, cut it. If a section feels complete and the reader would naturally want to know what comes next, the section is the right length.

**The visual break rule:** No more than 3-4 short paragraphs between visual elements (images, infographics, diagrams, CTA cards, social proof screenshots). If you count four consecutive paragraphs without a visual break, insert one.
...
**Job:** Stop the scroll. Create instant relevance. Signal that something worth reading is below.
...
- Hero image cut at fold line (signals scrollable content below)
- NO CTA above fold on cold traffic (feels premature)
- If ad didn't filter the audience, the headline or subheadline MUST do the filtering

### Section 2: Lead (WRITTEN LAST)

**Job:** Lock in the reader. Tease what they'll discover. Promise a benefit that makes the entire advertorial feel worth reading. Give them a reason to survive any slow or confusing section later.

**What a lead is NOT:** It is not the first paragraph of the story. It is not an introduction. It is a separate section that teases the full content, written after the full advertorial is complete.

**What a lead must accomplish (in any order that flows naturally):**
- Hook attention immediately with an emotionally charged statement
- Build immediate connection by showing understanding of their pain
- Create curiosity by teasing discoveries they'll make
- Promise a clear benefit for continuing to read
- Address initial skepticism upfront
...
**Job:** Build deep emotional identification. Lower the reader's defenses. Create the "this person gets me" moment. Establish the "nothing worked" loop that sets up the root cause reveal.

**What the story is NOT:** It is not a product story. It is not a sales pitch in narrative form. It is the reader's own story, told through someone they trust.

**Narrator options:**
- **Hero story:** First-person account from someone like the avatar ("I tried everything...")
- **Authority figure:** Doctor, expert, researcher who witnessed the struggle ("I see this in my patients...")
- **Caregiver/loved one:** Partner, parent, friend who watched the suffering ("I watched my wife...")
- **Founder story:** The brand creator who experienced the problem personally
...
**What System 1 compliance means in practice:**
- A tired person scrolling their phone at midnight must understand it
- No jargon. If any word requires medical/scientific knowledge, simplify it or add an analogy immediately
- Short sentences. Short paragraphs. Visual flow.
- A little science gives credibility; too much science causes bounce
- It should feel like a smart doctor explaining it in plain English for the first time

**Required elements:**

1. **Analogy (MANDATORY):** Every root cause needs at least one real-world analogy the reader is already familiar with. Search avatar communities (Reddit, forums, YouTube comments) for existing analogies. If none exist, create one that is visual, simple, and emotionally accurate.
...
3. **Villain Externalization:** The root cause must shift blame from the reader to an external factor:
   ...
   - Misinformation loop ("everything you've been told about X is incomplete")
...
### Section 5: Consequences / Negative Future Pacing

**Job:** Amplify urgency by showing what happens if the root cause ISN'T fixed. Make the need for a solution feel urgent, not someday-maybe.

**This section sits between root cause and unique mechanism for a reason:** The reader just understood what's causing their problem. Now, before you show them the fix, you show them what happens if they don't fix it. This creates a knowledge gap (I need a solution NOW) that the unique mechanism section fills.

**Techniques:**
- **Progression framing:** Show how the problem compounds over time (Nooro shows Stage 1 → Stage 2 → Stage 3 → Stage 4 with images)
- **Social proof of consequences:** Reference real community stories of people who didn't act
...
**Completion test:** Does the reader feel genuine urgency to find a solution RIGHT NOW, without feeling so hopeless they give up? If yes, transition to the mechanism.
...
**Writing rules (same System 1 principle as root cause):**
...
**Structure A: Frustration + Expert**
"I was frustrated nothing existed for [specific problem]. So I partnered with [expert/lab/formulator] to build something from scratch."
- Shows why existing products don't work (they're generic, they miss the root cause)
- Introduces credibility through partnership (doctors, researchers, labs)
- Makes the creation story feel difficult and high-stakes

**Structure B: Discovery + Validation**
"After discovering the mechanism, I spent [time] testing formulations. Most failed. But when we got the doses right..."
- Shows rigor and iteration (not thrown together overnight)
- Clinical doses, not proprietary blends
- FDA-registered facility, real sourcing, third-party testing

**What to include:**
- Why this exact solution didn't already exist
- How hard it was to create (difficulty = premium perception)
- Who was involved (experts, partnerships, labs)
- What makes it different from DIY, Amazon knockoffs, or generic alternatives
- Clinical/quality credentials (doses, sourcing, manufacturing)
...
**Job:** Turn belief into a buying decision. Not through pressure. By making this feel like the easiest, most obvious financial decision they've made all year.
...
- Format: name + context, specific outcome, relatable detail

**9b. Positive Future Pacing**
- Paint the transformation they've been craving
- Use THEIR language for the desired state (from avatar research)
...
- Make comparison categories natural:
  - Doctor/specialist consultations ($200-$1,200)
  - Competing premium products ($150-$300)
  - Salon/professional treatments ($100-$500/session)
  - The "doing nothing" cost (emotional, social, career impact)
- Reader's mental frame shifts from "is $49 worth it" to "compared to THOSE, $49 is nothing"
...
- Each bonus should feel independently valuable
...
4. **Humanity:** Does it sound like a real person, not marketing copy? No polished language, no fancy vocabulary. Just truth that hits. It should sound like something you overheard at a cafe.

5. **Contextual Fit:** Does it align with the ad the reader just clicked? If the ad filtered for a specific condition, does the headline match? If the ad was emotionally charged, does the headline match that weight?

### Headline Quality Check

After writing headlines, gut-check each one against these questions (directly from the masterclass):

- Does it stop the scroll?
- Does it mirror something the reader has actually lived?
- Does it match the level of awareness?
- Does it open a loop or create a knowledge gap?
- Does it align with the ad they just came from?
- Does it feel real, not like copywriting?
- Does it speak to the right person and repel the wrong one?
- Would you feel something reading this, or would you scroll past?

**If even one answer is "no," don't ship it. Rework until every answer is "yes."**
...
| If the ad was... | The headline should... |
|-----------------|----------------------|
| Ugly image, no context | Filter to avatar (mention specific condition/situation) |
| Curiosity/clickbait image | Anchor the pain, create relevance |
| UGC with product mention | Lean into emotional weight, skip re-filtering |
| Long VSL (emotionally charged) | Match tone, don't repeat; go specific |
| Advertorial ad copy | Bridge to logical next step |

### Headline Inspiration Sources

- Top all-time posts in avatar subreddits (most emotionally resonant language, written by real people)
- News article headlines (BuzzFeed-style curiosity engineering)
- Raw quotes from avatar research (the way they actually talk)
...
**Position 1: Soft CTA (Optional, around 35-40% scroll)**
- Subtle inline link or small button after consequences section
- Low-friction language ("Learn more" / "Discover the solution")
- Purpose: Catch readers who are already convinced and don't need the full journey

**Position 2: Mid-Page CTA Card (around 55-65% scroll)**
- Full card with product image
- Placed after product reveal section
- 2-column: image left (40%), content right (60%)
- Includes: headline, 3-4 benefit checkmarks, value proposition, CTA button, trust line
- Configured per brand

**Position 3: After Social Proof (around 70% scroll)**
- Button or inline CTA
- Leverages social proof momentum

**Position 4: FAQ Soft CTAs (around 80-90% scroll)**
- Inline within FAQ answers (especially guarantee-related)
- Low-friction reinforcement

**Position 5: Final CTA Card (near bottom of page)**
- Full card, strong contrast background
- Urgency-focused copy from close section
- Product image, CTA button, trust elements

**Position 6: Mobile Sticky CTA**
- Fixed to bottom, triggers at 40% scroll
- CTA text per brand configuration
- Full-width, high contrast, 56px minimum height

## Social Proof Section

**Placement:** After product reveal, before or within close section

**Match testimonial demographics to target avatar.** If targeting women with PCOS, show women with PCOS. If targeting analytical males, show analytical males.

**Testimonials should feel real.** iPhone-quality selfie photos, not studio shots. Real language from real people. Specific outcomes and timelines, not vague praise. Include photos from the customer if available.

## FAQ Section

**Mandatory for mid-ticket and above.** Accordion-style (collapsed by default).

**Question categories (select from):**
1. Product-specific: "How does it work?" / "What's included?"
2. Comparison: "How is this different from [alternative]?"
3. Risk-related: "What if it doesn't work for me?"
4. Logistics: "How long until I see results?" / "Shipping?"
5. Purchase-related: "Is there a guarantee?" / "Payment plans?"
...
**Recommended placements (choose max 2):**

| Position | Video Type | Max Length | Behavior |
|----------|-----------|------------|----------|
| Hero (above fold) | Brand/problem hook | 15-60 sec | Autoplay muted (desktop), poster (mobile) |
| After root cause (~35%) | Product demo / explainer | 1-2 min | Click to play, poster visible |
| Social proof section (~65%) | Customer testimonial | 1-3 min | Click to play |
| Before final CTA (~90%) | Results / transformation | 30-90 sec | Click to play |
...
- All images: alt text, optimized (<200KB, hero <300KB)
...
Every funnel page MUST include this script in the `<head>` tag. It captures UTM parameters from the ad click URL and appends them to ALL CTA links on the page, ensuring accurate attribution from ad platform through to purchase.

```html
<script>
(function() {
  var defined_params = ['utm_source', 'utm_medium', 'utm_campaign', 'utm_content', 'utm_term'];
  var defined_params_values = {};
  var url_params = new URLSearchParams(window.location.search);

  defined_params.forEach(function(p) {
    var v = url_params.get(p);
    if (v) defined_params_values[p] = v;
  });

  if (Object.keys(defined_params_values).length === 0) return;

  function appendUTMs(link) {
    try {
      var url = new URL(link.href, window.location.origin);
      Object.keys(defined_params_values).forEach(function(p) {
        url.searchParams.set(p, defined_params_values[p]);
      });
  ...
  document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('a[href]').forEach(appendUTMs);

    var observer = new MutationObserver(function(mutations) {
      mutations.forEach(function(m) {
        m.addedNodes.forEach(function(node) {
          if (node.nodeType === 1) {
            if (node.tagName === 'A' && node.href) appendUTMs(node);
            node.querySelectorAll && node.querySelectorAll('a[href]').forEach(appendUTMs);
          }
        });
      });
    });
